 ...
 * Use the [ProductDetailRecomendation.newInstance] factory method to
...
class ProductDetailRecomendation : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ProductDetailRecomendation.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ProductDetailRecomendation().apply {
